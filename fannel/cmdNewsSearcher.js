...
setVariableType="REMOVE_WEB_SEARCH_PREFIX:ELCBB=${WEB_SEARCH_PREFIX_FILE_PATH}|jsf '${0}' remove_web_search_prefix!del"
setVariableType="SEARCH_TEXT:ELCB=${SEARCH_LIST_FILE_PATH}!30"
setVariableType="REMOVE_SEARCH_TEXT:ELCBB=${SEARCH_LIST_FILE_PATH}|jsf '${0}' remove_search_text!del"

...
setVariableType="LAUNCH_URL:ELCB=${LIST_PATH}=${URL_LIST_FILE_PATH}"
setVariableType="REMOVE_LAUNCH_URL:ELCBB=${LIST_PATH}=${URL_LIST_FILE_PATH}|${BTN_CMD}=jsf '${0}' REMOVE_LAUNCH_URL!${BTN_LABEL}=tst"

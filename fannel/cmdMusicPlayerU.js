...
scriptFileName="cmdMusicPlayerU.js"
/// SETTING_SECTION_END
...
function switchByArgs(){
	...
	switch(FIRST_ARGS){
		...
		case SHUFFLE_MODE:
			...
			jsUbuntu.execScriptByBackground(
				EXEC_SHELL_PATH,
				`${SHUFFLE_MODE}\t${EDIT_FILE_PATH}\t${musicDir}`,
				1,
			);
			break;
		case ORDINALY_MODE:
		case REVERSE_MODE:
			...
			jsUbuntu.execScriptByBackground(
				EXEC_SHELL_PATH,
				`${ORDINALY_MODE}\t${EDIT_FILE_PATH}\t${musicDir}`,
				1,
			);
			break;
		case NUMBER_MODE:
			...
			jsUbuntu.execScriptByBackground(
				EXEC_SHELL_PATH,
				`${NUMBER_MODE}\t${EDIT_FILE_PATH}\t${musicDir}\t${numberPlay}`,
				1,
			);
			break;
